...
SECRET_KEY = "django-insecure-bl8pw)1$h(9=xbt8lzojhv2qcy_tfp11c0u^b=!zwqp*f7u6$8"
    ...
    "formatters": {
        "task_manager": {
            ...
            "format": (
                ...
                "view={view.__qualname__} user={user_id} remote={remote_addr} duration={duration} {message}"
            ),
            "style": "{",
        },
    },
